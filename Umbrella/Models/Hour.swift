...
class Hour: NSObject {
    ...
    var hour: String, min: String, year: String, mon: String, mon_abbrev: String, mday: String, mday_padded: String, yday: String, pretty: String, civil: String, month_name: String, month_name_abbrev: String, weekday_name: String, ampm: String, temp: [String: String], condition: String, icon: String, sky: String, snow: [String: String];
    
    
    init(hour: String, min: String, year: String, mon: String, mon_abbrev: String, mday: String, mday_padded: String, yday: String, pretty: String, civil: String, month_name: String, month_name_abbrev: String, weekday_name: String, ampm: String, temp: [String: String], condition: String, icon: String, sky: String, snow: [String: String]){
        self.hour = hour
        self.min = min
        self.year = year
        self.mon = mon
